...
export function ClientPortalLayout({ children }: ClientPortalLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-[#e9e9e9] p-4 text-[#171717]">
      <div className="mx-auto min-h-[calc(100vh-32px)] max-w-[1200px] overflow-hidden rounded-[34px] border border-white/80 bg-white/32 shadow-[0_30px_100px_rgba(0,0,0,0.18)] backdrop-blur-3xl">
